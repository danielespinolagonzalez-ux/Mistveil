...
**Fase actual:** R1 COMPLETA (validada R0 por Daniel: "funciona de coña"). Siguiente: R2 (sellos elementales) — necesita decisión de diseño de Daniel; en paralelo, dirección gráfica elegida por Daniel para R3.
