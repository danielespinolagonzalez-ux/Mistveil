...
**Fase actual:** R2 núcleo COMPLETO (Daniel decidió: sellos = botín de jefes). Pendiente: R2.5 (selector en menú) y que Daniel elija dirección gráfica para R3. Siguiente fase: R3 (contenido de la Torre).
